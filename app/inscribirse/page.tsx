...
function InscribirseForm() {
  ...
  const { estado: estadoAuth, email: emailAuth, login } = useUser()
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="max-w-md w-full text-center space-y-6 py-12">
          ...
          <p className="text-muted-foreground">
            Para inscribirte en un taller, ingresá con tu cuenta de Google.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={login}
              className="inline-flex items-center justify-center gap-2 border border-gray-300 hover:border-gray-400 bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 px-6 rounded-xl transition-colors shadow-sm"
            >
