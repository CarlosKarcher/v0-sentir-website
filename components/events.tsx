...
export function Events() {
  ...
  const events = [
    ...
    },
    {
      ...
      time: "Inicio: Viernes 25 de Septiembre, 17 Horas",
      location: "Avda. Jorge Alessandri #264 Barrio Sur - Club Huracán",
      type: "Taller de Liderazgo",
      available: true,
      availabilityText: "Cupos disponibles",
      hasFlyer: true,
      flyerImage: "/auto punta arenas 250926.jpeg",
      flyerImageAlt: "/images/auto punta arenas 250926.jpeg",
      level: "1er Nivel",
      contactPhone: "+56 9 6113 0835",
      tallerSlug: "autoconocimiento",
      sede: "Punta Arenas",
    ...
    {
      title: "Taller de Autoconocimiento - Río Gallegos",
      date: "16, 17 y 18 de Octubre 2026",
      time: "Inicio: Viernes 16 de Octubre, 16:30 Horas",
      location: "Lugar a Confirmar",
      type: "Taller de Liderazgo",
      available: true,
      availabilityText: "Cupos disponibles",
