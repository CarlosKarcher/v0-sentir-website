...
export function SentirDesdeAdentro() {
  ...
  return (
    <section id={SECTION_IDS.SENTIR_DESDE_ADENTRO} className="py-12 sm:py-16 md:py-20 bg-secondary/30 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <Card className="overflow-hidden">
              <CardContent className="p-0">
                <div className="relative w-full" style={{ aspectRatio: "16/9" }}>
                  <video
                    src="/Video-transfor-abril-2026.mp4"
                    controls
                    className="w-full h-full object-contain mx-auto block"
                    preload="metadata"
                    playsInline
            ...
            <Card className="overflow-hidden">
              <CardContent className="p-0">
                <div className="relative w-full" style={{ aspectRatio: "16/9" }}>
                  <video
                    src="/video-transfor-abril-2026-2.mp4"
                    controls
                    className="w-full h-full object-contain mx-auto block"
                    preload="metadata"
                    playsInline
