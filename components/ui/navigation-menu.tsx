      ...
      requestAnimationFrame(() => {
        ...
        if (viewport && contents.length > 0) {
          ...
          if (maxHeight > 0 && maxWidth > 0) {
            viewport.style.setProperty('--radix-navigation-menu-viewport-height', `${maxHeight}px`)
            viewport.style.setProperty('--radix-navigation-menu-viewport-width', `${maxWidth}px`)
          }
        }
      })
    }
    
    // Multiple attempts to ensure viewport is calculated
    updateViewport()
    const timers = [
