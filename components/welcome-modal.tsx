...
export function WelcomeModal() {
  const { estado, loginWithToken, login } = useUser()
  ...
  // Renderiza el botón de Google cuando el modal se hace visible
  useEffect(() => {
    if (!visible || !btnRef.current || !CLIENT_ID) return
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 pointer-events-none">
        ...
        >
          ...
          <div className="px-6 py-6 space-y-4">
            ...
            {/* Botón oficial de Google renderizado por GSI */}
            <div className="flex justify-center min-h-[44px]">
              {CLIENT_ID ? (
                ...
                <button
                  onClick={login}
                  className="flex items-center gap-3 border border-gray-300 hover:border-gray-400 bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 px-6 rounded-xl transition-colors shadow-sm text-base"
                >
