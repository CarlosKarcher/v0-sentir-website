-- FASE 3: Eliminar constraint única en talleres para permitir mismo slug+sede con distinta fecha
-- Ejecutar en Supabase SQL Editor

-- ─── Eliminar constraint única slug+sede ─────────────────────────────────────
-- Esto permite tener 5 talleres de "autoconocimiento" en "Río Gallegos" con fechas distintas
ALTER TABLE public.talleres
  DROP CONSTRAINT IF EXISTS talleres_slug_sede_key;

-- ─── insertar_taller_admin (crea o actualiza según ID) ────────────────────────
