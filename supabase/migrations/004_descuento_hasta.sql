-- Agrega columna descuento_hasta a talleres
...
begin
  ...
  update public.talleres set
    ...
    descuento_hasta      = p_descuento_hasta,
    sede                 = p_sede,
...
begin
  ...
  insert into public.talleres (slug, nombre, sede, precio, descuento_tipo, descuento_valor, descuento_hasta, fecha_inicio, activo)
  values (
    p_slug,
    p_nombre,
    p_sede,
